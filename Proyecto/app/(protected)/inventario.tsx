...
const inventario = [
    ...
    {id: '3', nombre:'Excritorio', categoria:'Muebles', cantidad:15},
]
...
const style = StyleSheet.create({
    ...
    item: {marginLeft:20, padding:10, backgroundColor:"#fff", borderColor:"#78786d", borderWidth:2, borderRadius:10},
